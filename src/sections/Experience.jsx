const experiences = [
    ...
    },
    {
        ...
        // company: "Eclerx",
        description: "Created visual assets for digital platforms including social media content, layout compositions, and promotional materials. Applied design principles such as spacing, hierarchy, and color balance to ensure clarity and engagement. Developed a stronger understanding of visual communication and brand presentation across different formats.",
        technologies: ["Adobe Photoshop", "Canva"],
        current: false,
    },
];
            ...
            <div className="container mx-auto px-6 relative z=10">
                ...
                <div className="max-w-xl mb-16">
                    <span className="text-secondary-foreground text-sm font-medium tracking-wider uppercase animate-fade-in">
                        Career Journey</span>
                    <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6 animate-fade-in animation-delay-100 text-secondary-foreground">Experience built 
                        <span className="font-serif italic font-normal text-white"> through real-world interaction.</span>
                    </h2>
                    <p className="text-muted-foreground animate-fade-in animation-delay-200 text-justify">
